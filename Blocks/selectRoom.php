    ...
    <form id="myForm" action="<?php htmlspecialchars($_SERVER["PHP_SELF"]) ?>" method="post">
        <div class="w-100 m-auto pl-3 d-flex justify-content-center flex-column mb-3 ">
            ...
            <div class="form-group fs-1 pt-0">
                ...
                <input type="text" class="form-control h-85 w-75 fs-1" name="Block" autocomplete="off" value="Krishnaveni">
            </div>
            <div class="form-group fs-1 pt-0">
                ...
                <div id="collapseOne" class="accordion-collapse collapse showzzzzzzzz" data-bs-parent="#accordionExample">
                    <div class="accordion-body">
                        <?php
                            ...
                            WHERE c.status ='Available' and b.Block_ID=1 and f.Floor_Name='G'";
                    $res = mysqli_query($conn, $sql);
                    ...
                    if ($res) {
                        ...
                        if ($count > 0) {
                            ...
                            echo '<thead><tr><th scope="col">RoomNo</th><th scope="col">CotNo</th><th scope="col">Status</th></tr></thead>';
            ...
            <div class="accordion-item">
                ...
                <div id="collapseTwo" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                    ...
                    <?php
                        ...
                        JOIN floor f ON f.Floor_ID = r.Floor_ID
                        JOIN block b ON f.Block_ID = b.Block_ID
                        WHERE c.status ='Available' and b.Block_ID=1 and f.Floor_Name='F'";
                        $res = mysqli_query($conn, $sql);
            ...
            <div class="accordion-item">
                ...
                <div id="collapseThree" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                    ...
                    <?php
                        ...
                        JOIN floor f ON f.Floor_ID = r.Floor_ID
                        JOIN block b ON f.Block_ID = b.Block_ID
                        WHERE c.status ='Available' and b.Block_ID=1 and f.Floor_Name='S'";
                        $res = mysqli_query($conn, $sql);
